...
describe Game do
  ...
  describe ".recent" do
    it "returns the previous games" do 
      game1 = Game.create(computer_throw: "paper", user_throw: "rock")
      game2 = Game.create(computer_throw: "paper", user_throw: "paper")
      game3 = Game.create(computer_throw: "paper", user_throw: "scissors")

      expect(Game.recent.length).to eq 3 
    end
  end
